...
- No JS framework/build step — trend charts are hand-rolled SVG
  (`app/charts.py` shapes data server-side, `app/static/trend_chart.js`
  draws + wires interaction client-side).
